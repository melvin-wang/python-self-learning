...
class report_painter:
    ...
    def PriceGridPaint(self):
        ...
        # 其他线条
        self.paint.drawLine(0, self.h - self.grid_padding_bottom, self.w - self.grid_padding_right + 44,
                            self.h - self.grid_padding_bottom)
    ...
    def topInfoPaint(self):
        ...
        # 涨停价
        self.setPen('red')
        self.paint.drawText(4 + self.grid_padding_left + 200, self.grid_padding_top - 4,
                            str('涨停价:%.2f' % (lastclose * 1.1)))  # 均价
        # 跌停价
        self.setPen('green')
        self.paint.drawText(4 + self.grid_padding_left + 280, self.grid_padding_top - 4,
                            str('跌停价:%.2f' % (lastclose * 0.9)))  # 均价
